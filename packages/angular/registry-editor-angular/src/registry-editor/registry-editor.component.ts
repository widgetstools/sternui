...
import { ICON_NAMES, ICON_META } from '@starui/icons-svg';
import { iconIdToSvgUrl } from '@starui/angular-dock-editor';
...
/**
 * Registry-editor design tokens — 100% derived from @starui/design-system.
 *
...
export class IconUrlPipe implements PipeTransform {
  transform(iconId: string, theme: 'dark' | 'light'): string {
    ...
    // values from @starui/design-system rather than hardcoding them.
