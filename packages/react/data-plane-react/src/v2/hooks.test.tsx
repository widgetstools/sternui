...
import { createInPageWiring } from '@starui/data-plane/v2/client';
import { Hub, registerProvider, type PortLike } from '@starui/data-plane/v2/worker';
import type { ProviderConfig } from '@starui/shared-types';
import type { ProviderEmit, ProviderHandle } from '@starui/data-plane/v2/worker';
