 ...
 * `@starui/host-data`) so the dependency stays one-way. The
 * `AppDataMirror` instance from `@starui/host-data` already
 ...
 * `bootstrapDataServices` from `@starui/host-data`; structural
