    ...
    alias: [
      {
        ...
        replacement: resolve(__dirname, '../../shared/design-system/dist/adapters/agGrid.js'),
      },
      {
        find: '@starui/design-system/tokens',
        replacement: resolve(__dirname, '../../shared/design-system/dist/tokens/index.js'),
      },
      {
        find: '@starui/design-system',
        replacement: resolve(__dirname, '../../shared/design-system/dist/index.js'),
      },
      ...
      { find: '@starui/ui', replacement: resolve(__dirname, '../ui/dist/index.js') },
    ],
  },
  test: {
    environment: 'jsdom',
