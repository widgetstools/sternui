 ...
 *      IndexedDB / Dexie persistence layer (`@starui/config-service`'s
...
import type { UnifiedConfig } from '@starui/shared-types';
import {
  COMPONENT_TYPES,
...
export class DataProviderConfigService {
   ...
   *
   * The reference app wires `@starui/config-service`'s `ConfigManager`
