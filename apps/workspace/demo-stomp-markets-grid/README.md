...
For AppData bootstrap and grid event callback patterns without STOMP, see [`apps/workspace/platform-hooks-demo`](../platform-hooks-demo/README.md).
...
node apps/workspace/demo-stomp-markets-grid/launch.mjs
