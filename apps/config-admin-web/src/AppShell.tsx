...
import { AppScopeProvider, useAppScope } from './AppScopeContext';
import { AppSelector } from './AppSelector';
import { AppConfigList } from './views/AppConfigList';
import { AppsOverview } from './views/AppsOverview';
  ...
  return (
    <Routes>
      <Route element={<Outlet />}>
        ...
        <Route path="/configs" element={<AppConfigList />} />
        <Route
          path="/users"
          element={
            <UserProfileGate>
...
function UserProfileGate({ children }: { children: React.ReactNode }) {
  ...
  if (!appId) {
    return (
      ...
      >
        Choose an application above (or open it from the Apps page) to
        scope user profiles.
      </div>
    );
  }
