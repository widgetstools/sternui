...
For AppData bootstrap and grid event callback patterns without STOMP, see [`apps/platform-hooks-demo`](../platform-hooks-demo/README.md).
...
node apps/demo-stomp-markets-grid/launch.mjs
