...
export const routes: Routes = [
  ...
  // Calls initWorkspace() to register the dock, home, store, etc.
  {
    ...
    loadComponent: () => import('./platform/provider.component').then((m) => m.ProviderComponent),
  },

  // Sample views — launched as OpenFin Views from the dock
  {
    path: 'views/view1',
    loadComponent: () => import('./views/view1.component').then((m) => m.View1Component),
  },
  {
    path: 'views/view2',
    loadComponent: () => import('./views/view2.component').then((m) => m.View2Component),
  },
