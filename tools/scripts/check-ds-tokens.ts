...
const ALLOW_PATHS = [
  'starui-platform/packages/design-system/design-system/src/',
  'patch/',  // working dir, deleted at end of migration
  // --- Legitimate hex data (not styling) ---
  'starui-platform/packages/design-system/icons-svg/',
  'starui-platform/packages/openfin/openfin-platform/src/',
  'starui-platform/packages/design-system/design-system/tests/',
  'starui-platform/packages/react-core/widgets-react/src/v2/markets-grid-container/MarketsGridContainer.tsx',
  'starui-platform/packages/react-grid/grid/src/customizer/ui/ExpressionEditor/language.ts',
  'starui-platform/packages/react-ui/ui/src/components/chart.tsx',
  'starui-platform/packages/react-grid/grid/src/customizer/ui/format-editor/FormatColorPicker.tsx',
  'starui-platform/packages/react-grid/grid/src/customizer/ui/format-editor/types.ts',
  'starui-platform/packages/react-grid/grid/src/customizer/ui/ColorPicker/CompactColorField.tsx',
  'starui-platform/packages/react-grid/grid/src/customizer/ui/shadcn/color-picker.tsx',
  'starui-platform/packages/react-grid/grid/src/customizer/ui/StyleEditor/BorderStyleEditor.tsx',
  'starui-platform/packages/react-grid/grid/src/customizer/modules/conditional-styling/styleBridge.ts',
  'starui-platform/packages/react-grid/grid/src/customizer/modules/conditional-styling/ConditionalStylingPanel.tsx',
  // --- Tool scripts themselves ---
  'tools/',
  // --- Test files: hex in assertion fixtures ---
  'starui-platform/e2e/',
  'starui-platform/packages/react-grid/grid/src/widget/FormattingToolbar.test.tsx',
  'starui-platform/packages/react-grid/grid/src/customizer/modules/column-customization/formattingActions.test.ts',
  'starui-platform/packages/react-grid/grid/src/customizer/modules/column-templates/snapshotTemplate.test.ts',
  'starui-platform/packages/react-core/widgets-react/src/hosted/__tests__/useColorLinking.test.tsx',
  'starui-platform/packages/react-core/widgets-react/src/hosted/useColorLinking.ts',
