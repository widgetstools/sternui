...
export const CONFIG_OR_CODE_RULES: ConfigOrCodeRule[] = [
  ...
  },
  {
    ...
    rationale: 'Application chrome uses @starui/ui recipes — outside grid layout modules.',
  },
  {
    ...
    rationale: 'New renderer types extend @starui/design-system; MCP then generates layouts using the new renderer id.',
  },
  {
    ...
    rationale: 'New customizer modules ship in @starui/grid; layouts reference existing module ids.',
  },
  {
