...
export const PLATFORM_TOOLS: ToolDefinition[] = [
  ...
  { name: 'starui_list_ui_components', description: 'List @starui/ui shadcn exports and recipes', inputSchema: { type: 'object', properties: {} } },
  ...
  { name: 'starui_explain_import_alias', description: 'Explain @starui import vs tarball dep mapping', inputSchema: { type: 'object', properties: { importPath: { type: 'string' } } } },
  ...
  { name: 'starui_shadcn_component_picker', description: 'Pick @starui/ui components from description', inputSchema: { type: 'object', properties: { description: { type: 'string' } }, required: ['description'] } },
