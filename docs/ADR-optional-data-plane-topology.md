...
|-------|------|----------------|
| **0** | Keep monolith; QoS (provider `throttleMs` defaults, prioritize attach/replay over live, Config Browser off FullGate) | Tool open &lt; 1s with hot blotter; documents R1–R6 against current hub |
