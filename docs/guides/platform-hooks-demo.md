...
Hands-on documentation for the **`apps/platform-hooks-demo`** app. Use it to validate **AppData bootstrap** and **MarketsGrid event callbacks** without a STOMP broker.
...
- App README: [`../../apps/platform-hooks-demo/README.md`](../../apps/platform-hooks-demo/README.md)
- Bootstrap config reference: [platform-bootstrap-config.md](./platform-bootstrap-config.md)
- Minimal STOMP sample (subset of hooks): [`../../apps/stomp-marketsgrid-minimal/`](../../apps/stomp-marketsgrid-minimal/)
...
From `apps/platform-hooks-demo/public/app-config.json`:
