...
### Phase C-3 — split MarketsGrid.Host (611 LOC) (2026-04-29) — **REVERTED on 2026-04-29**
This entry is preserved for history. The split caused 17 new e2e failures (16 in profile-* specs) and a user-visible slowdown in profile flows. Reverted in commit `<see C-3 REVERT entry above>`. Don't attempt this split again without first adding profile-stress unit tests AND running the full Playwright e2e suite as part of verification.
