...
| Server-Side Row Model — filtering, sorting, pivoting, grouping, calc cols, formatting, searching, viewport | Client-side row model only; data services do snapshot+tail. **Planned:** Perspective as transparent shared cache + SSRM — see [`docs/superpowers/specs/2026-07-13-perspective-ssrm-transparent-integration-design.md`](./superpowers/specs/2026-07-13-perspective-ssrm-transparent-integration-design.md) | 30 | 5 | Major gap if SSRM required; design approved 2026-07-13 |
