...
// Vanilla shells from @stargrid/engine — only the constants + the
// `MemoryAdapter` class that MarketsGrid uses for default storage.
vi.mock('@stargrid/engine', async () => {
  const actual: any = {};
  return {
    ...actual,
...
// React shells from @stargrid/grid/customizer — hooks, panel primitives,
// shadcn primitives, and module registry exports.
vi.mock('@stargrid/grid/customizer', async () => {
  const actual: any = {};
  return {
    ...actual,
