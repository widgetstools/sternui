 ...
 *      IndexedDB / Dexie persistence layer (`@stargrid/host-config`'s
...
import type { UnifiedConfig } from '@stargrid/types';
import {
  COMPONENT_TYPES,
...
export class DataProviderConfigService {
   ...
   *
   * The reference app wires `@stargrid/host-config`'s `ConfigManager`
