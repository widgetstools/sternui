 ...
 *
 * Subpaths:
 *   `@stargrid/host-data/runtime`               — main thread (client + protocol types)
 *   `@stargrid/host-data/runtime/sharedWorker`  — SharedWorker entry + SharedWorkerDataServicesHub
 *   `@stargrid/host-data/runtime/client`        — SharedWorkerDataServicesClient
 */
