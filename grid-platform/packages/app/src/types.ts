...
import type { ConfigPort, DataPort, RuntimePort } from '@stargrid/host';
import type { ConfigClient, ConfigManager } from '@stargrid/host-config';
import type { StorageAdapterFactory } from '@stargrid/grid';
import type { Theme, Unsubscribe } from '@stargrid/types';
...
export interface StarGridAppState {
  ...
  hostForGrid(scope: StarGridHostScope): import('@stargrid/host').GridHostContext;
}
