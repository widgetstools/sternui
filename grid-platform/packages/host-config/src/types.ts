 ...
 * `@stargrid/host-data`) so the dependency stays one-way. The
 * `AppDataMirror` instance from `@stargrid/host-data` already
 ...
 * `bootstrapDataServices` from `@stargrid/host-data`; structural
