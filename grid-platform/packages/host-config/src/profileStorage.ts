...
// Type-only import — @stargrid/engine is a peerDependency so the types
...
import type { ProfileSnapshot, StorageAdapter } from '@stargrid/engine';
...
export const CONFIG_SERVICE_ADAPTER_BRAND = Symbol.for(
  '@stargrid/host-config/profile-storage-adapter',
);
