/**
 * React bindings for `@stargrid/host-data` — one context provider +
 * focused hooks.
 *
 * Surface:
...
import type {
  ...
  StatsListener,
} from '@stargrid/host-data/runtime/client';
import {
  AppDataMirror,
  DataProviderConfigStore,
  resolveCfg,
  type DataServices,
} from '@stargrid/host-data/runtime';
import type { ProviderStatus } from '@stargrid/host-data/runtime';
import type { DataProviderConfig, ProviderConfig } from '@stargrid/types';
