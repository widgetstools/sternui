/**
 * Side-effect-free config entry point for @stargrid/openfin-platform.
 *
 ...
 *   does `import { setConfigManager } from '@stargrid/openfin-platform'`
 ...
 *   the demo apps) import from `@stargrid/openfin-platform/config`
