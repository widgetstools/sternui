// ─── Dock + Registry persistence (backed by @stargrid/host-config) ───
//
...
//     canonical constants exported from `@stargrid/types`.
...
import type { AppConfigRow } from "@stargrid/host-config";
import { COMPONENT_TYPES } from "@stargrid/types";
