...
import type { DataServices } from '@stargrid/host-data/runtime';
import { DataServicesProvider } from '@stargrid/host-data-react/runtime';
import type { MarketsGridHandle } from '@stargrid/grid';
import { MarketsGridContainer, type MarketsGridContainerProps } from '../markets-grid-container/index.js';
...
> extends Omit<MarketsGridContainerProps<TData>, ContainerOwnedKeys> {
   ...
   *  is resolved via `@stargrid/openfin-platform/config`. Pass an
